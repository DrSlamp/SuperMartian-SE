...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_2, "2")
...
SOUNDS["pickup_coin"].set_volume(0.1)

pygame.font.init()

FONTS = {
    "verysmall": pygame.font.Font(BASE_DIR / "fonts" / "font.ttf", 6),
